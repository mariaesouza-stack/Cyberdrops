...
export const COMMUNITY_USERS: User[] = [
  ...
  { id: 3, name: 'PixelStorm', username: '@pixelstorm', email: '', phone: '', avatar: CYBER_AVATARS[1], bio: 'Drops rápidos e jogos indie' },
  { id: 4, name: 'CyberLoot', username: '@cyberloot', email: '', phone: '', avatar: CYBER_AVATARS[2], bio: 'Cupons e recompensas digitais' },
  { id: 5, name: 'RTXQueen', username: '@rtxqueen', email: '', phone: '', avatar: CYBER_AVATARS[3], bio: 'Hardware, GPUs e setups RGB' },
  { id: 6, name: 'GameDropper', username: '@gamedropper', email: '', phone: '', avatar: CYBER_AVATARS[4], bio: 'Ofertas multiplayer para o squad' },
  { id: 7, name: 'BitNinja', username: '@bitninja', email: '', phone: '', avatar: CYBER_AVATARS[5], bio: 'Caçador silencioso de promoções' },
  { id: 8, name: 'LootMaster', username: '@lootmaster', email: '', phone: '', avatar: CYBER_AVATARS[6], bio: 'Especialista em bundles e DLCs' },
  { id: 9, name: 'GlitchCore', username: '@glitchcore', email: '', phone: '', avatar: CYBER_AVATARS[7], bio: 'Radar de descontos fora da curva' }
];
