...
@Component({
  ...
  template: `<main class="auth-page"><a class="back" routerLink="/">←</a><section class="auth-card">
    <div class="brand center"><span>CD</span>CyberDrops</div><div><p class="eyebrow">PLAYER ONE</p><h1>Entre no squad</h1><p class="muted">Sua próxima promoção está esperando.</p></div>
