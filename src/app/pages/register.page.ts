...
export class RegisterPage {
  ...
  register(): void { this.users.register({ id: Date.now(), name: this.name || 'Novo Player', username: this.username || '@player', email: this.email, phone: this.phone, avatar: '👾', password: this.password }); void this.router.navigateByUrl('/home'); }
}
