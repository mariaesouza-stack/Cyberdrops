...
@Component({
  standalone: true, imports: [BrlCurrencyPipe, DiscountLabelPipe, FormsModule, RouterLink, CouponCardComponent, CommentCardComponent, AppIconComponent, AppAvatarComponent],
