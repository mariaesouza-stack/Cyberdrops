...
@Component({
  standalone: true, imports: [CouponOfferCardComponent, OfferCardComponent, StoreFilterComponent],
  template: `<section class="page feed-page">
    ...
    <div class="feed">
      ...
      @else {
        ...
        @if (!visibleOffersCount()) { <div class="empty"><b>Sem drops por aqui.</b><span>Tente outro filtro.</span></div> }
      }
    </div>
  </section>`
})
